 ...
 *
 * If your module does not contain reducers or sagas you are not required to use this helper.
 *
 * Example:
 ...
 * @param storeManager
 */
export const importChunk = <TComponent extends ComponentType<any>>(
